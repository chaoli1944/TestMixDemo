...
//                    mRemoteViewList.add(0,(LiveSubVideoView)findViewById(R.id.live_cloud_view_1));
        ...
        refreshRemoteViewListener();

    }

    public void refreshRemoteViewListener(){
    ...
    private void linkMic() {
        ...
        if (isSelected) { // 停止连麦
            mRemoteViewList.add(0,(LiveSubVideoView)findViewById(R.id.live_cloud_view_1));
            mRemoteViewList.get(0).setVisibility(View.VISIBLE);
            ...
            mRemoteViewList.get(0).setVisibility(View.INVISIBLE);
            mRemoteViewList.remove(0);
