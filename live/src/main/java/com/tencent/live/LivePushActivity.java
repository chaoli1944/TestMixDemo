...
public class LivePushActivity extends LiveBaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        TRTCCloudImplListener trtcCloudImplListener = new TRTCCloudImplListener(LivePushActivity.this);

        mTRTCCloud.setListener(trtcCloudImplListener);
...
//        MixTranscodeUtils.mixTransCodeAuto2(mTRTCCloud,mRoomId);
    }
